function robotdraw_interactive(chain,varargin)
%
...
addParameter(ps,'PLOT_LINK',false);                  % plot link
...
addParameter(ps,'PLOT_ROTATE_AXIS',false);           % plot rotate axis
...
fprintf('[Robot simulation using interactive control] Done.\n');
